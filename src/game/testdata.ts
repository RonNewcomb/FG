...
const upback: PerFrameMoveEffects = { xOffset: -5000, yOffset: -5000 };
const downback: PerFrameMoveEffects = { xOffset: -5000, yOffset: +5000 };
...
export const fdata1: FrameData = {
    moves: [
        // HIT
        {
            ...
            effects: [upback, upback, downback, downback],
        },
        // stand idle
        {
